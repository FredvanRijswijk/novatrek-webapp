          ...
          {!isMultiDestination ? (
            ...
            <div className="relative" ref={dropdownRef}>
              <Input
                ...
                className={`h-12 ${errors.destination ? 'border-destructive' : ''}`}
              />
            ...
            <div className="space-y-3">
              <p className="text-sm text-muted-foreground">Build your multi-stop journey</p>
                            ...
                            <div className="absolute z-10 w-full mt-1 bg-background border rounded-lg shadow-lg max-h-48 overflow-y-auto">
                              {isSearching ? (
                                ...
                                <div className="p-3 text-center text-muted-foreground">
                                  <p className="text-xs">No destinations found</p>
                                </div>
                              ) : (
                                suggestions.map((destination) => (
                                <button
                        ...
                        {dest.destination && (
                          <div className="mt-2 p-2 bg-muted/50 rounded flex items-center gap-2">
                            ...
                            <div className="flex-1">
                              <p className="text-sm font-medium">{dest.destination.name}</p>
                              <p className="text-xs text-muted-foreground">{dest.destination.country}</p>
                            </div>
                          </div>
                        )}
            ...
            <div className="mt-4 p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">{formData.destination.country}</p>
                </div>
              </div>
            </div>
          )}
        ...
        <Card className="border-0 shadow-sm">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="startDate" className="text-sm font-normal text-muted-foreground">Start Date</Label>
                <Input
                  id="startDate"
                  type="date"
              ...
              <div>
                <Label htmlFor="endDate" className="text-sm font-normal text-muted-foreground">End Date</Label>
                <Input
                  id="endDate"
                  type="date"
                  ...
                  className={`mt-1.5 ${errors.endDate ? 'border-destructive' : ''}`}
                />
                {errors.endDate && (
            ...
            {formData.travelers.map((traveler: any, index: number) => (
              <div key={index} className="grid grid-cols-12 gap-3 items-end">
                ...
                <div className="col-span-4">
                  <Label className="text-sm font-normal text-muted-foreground">Relationship</Label>
                  <select
                ...
                <div className="col-span-2">
                  <Label className="text-sm font-normal text-muted-foreground">Age</Label>
                  <Input
                    type="number"
                    placeholder="-"
                    value={traveler.age || ''}
