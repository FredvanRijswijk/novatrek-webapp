    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full has-[[data-slot=sidebar][data-variant=inset]]:bg-sidebar",
            className
          )}
          {...props}
        >
...
function Sidebar({
  ...
  // During SSR, isMobile is undefined, so we render the desktop version
