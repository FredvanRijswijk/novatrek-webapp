...
function handleAuthToken(token, userId) {
...
window.addEventListener("novatrek-auth", (event) => {
...
if (window.location.hostname === "localhost" && window.location.port === "3000" || window.location.hostname === "novatrek.app") {
